...
int main() {
	...
	cout << " ______________________________________________________________\n\n"
		 << "      ПРОГРАММА РАССЧЕТА СТОИМОСТИ РАСХОДОВАННЫХ РЕСУРСОВ\n"
		 ...
		 << " ______________________________________________________________\n\n"
		 << " Сегодня " << get_present_date() << endl;

	// проверка присутствия файла данных. Если файл не найден 
	// - создание нового, с вводом всех данных прошлого периода
	check_file();
