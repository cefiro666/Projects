...
public:
	...
	void showFraction()
	{
		cout << static_cast<int>(numerator) << "/" << static_cast<int>(denominator) << endl;
	}
...
template <class T>
Fraction<T> Fraction<T>::lowterms(Fraction<T> var)
{
...
int main()
{
	...
	Fraction<char> fr1(1, 4);
	Fraction<char> fr2(2, 4);
	Fraction<char> fr3;
	fr3 = fr1 + fr2;
	fr3.showFraction();
	fr3 = fr1 - fr2;
