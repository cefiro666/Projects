...
void Parser::lineWidth(int lineWidth)
{
	string data, buffer;
	unsigned int pos = 0;
...
void Parser::parser(string data)
{
...
void Parser::delExtraItems(vector<string> extraItems)
{
	string items;
	unsigned int index;
